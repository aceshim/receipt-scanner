...
export default class Me extends React.Component {
  ...
  getSum(){
    ...
    for (var i = 0; i < data.length; i++) {
      sum += parseFloat(data[i].balance.replace('$','').replace(',',''))
    }
            ...
            <TouchableHighlight
              ...
              <View style={styles.followerTextContainer}>
                  ...
                  <Text style={styles.followerText} numberOfLines={1}>
                      <Ionicons style={styles.followIcon} name='logo-usd' size={16}/> {this.getSum()}
                  </Text>
              </View>
            </TouchableHighlight>
            <TouchableHighlight
              ...
              <View style={styles.followingTextContainer}>
                ...
                <Text style={styles.followerText} numberOfLines={1}>
                  <Ionicons style={styles.followIcon} name='ios-document' size={16}/> {this.getCount()}
                </Text>
              </View>
            </TouchableHighlight>
            <TouchableHighlight
